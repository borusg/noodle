...
describe 'Noodle' do
  it "should fail to create a node with the same name as an existing node" do
    post '/nodes/zozo.example.com', params = '{"ilk":"host","status":"surplus","params":{"site":"moon","project":"hr","prodlevel":"dev"}}'
    assert_equal last_response.status, 201, 'First create'
    Noodle::Node.gateway.refresh_index!

    post '/nodes/zozo.example.com', params = '{"ilk":"yabba","status":"foo","params":{"site":"moon","project":"hr","prodlevel":"dev"}}'
