...
describe 'Noodle' do
  it "should fail to create a node with the same name as an existing node" do
    post '/nodes/zozo.example.com', params = '{"params":{"ilk":"host","status":"surplus","site":"moon","project":"hr","prodlevel":"dev"}}'
    assert_equal last_response.status, 201, 'First create'
    Noodle::Node.gateway.refresh_index!

    post '/nodes/zozo.example.com', params = '{"params":{"ilk":"yabba","status":"foo","site":"moon","project":"hr","prodlevel":"dev"}}'
